...
class Solution:
    ...
    def trap_optimal(self, height: List[int]) -> int:
        # APPROACH 2: Two pointers technique that can reduce the space complexity to O(1)
    ...
    def trap(self, height: List[int]) -> int:
        # The concept here is water that is going to get stored above any building would depend upon largest height
        # of building to it's left
