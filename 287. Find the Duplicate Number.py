...
class Solution:
    ...
    def findDuplicate_fast_slow_pointer(self, nums: List[int]) -> int:
    ...
    def findDuplicate_cyclic_sort(self, nums: List[int]) -> int:
    ...
    def findDuplicate_non_optimal(self, nums: List[int]) -> int:
